const questions = [
    ...
    },
    {
        ...
        answer: "16진수 변환\n방법: 소수점을 기준으로 4비트씩 그룹화 (16 = 2⁴)\n정수 부분: 1010100111011010\n1010 | 1001 | 1101 | 1010\n  A  |   9  |   D  |   A\n소수 부분: 1010111\n오른쪽에 0을 추가하여 4의 배수로 만듦: 10101110\n1010 | 1110\n  A  |   E\n16진수 결과: A9DA.AE\n8진수 변환 (다시 계산)\n정수 부분: 1010100111011010\n오른쪽부터 3비트씩 그룹화:\n1|010|100|111|011|010\n왼쪽 끝이 1비트이므로 앞에 00 추가: 001010100111011010\n001 | 010 | 100 | 111 | 011 | 010\n 1  |  2  |  4  |  7  |  3  |  2\n소수 부분: 1010111\n왼쪽부터 3비트씩 그룹화하고, 부족하면 오른쪽에 0 추가:\n101 | 011 | 1 → 101 | 011 | 100\n 5  |  3  |  4\n8진수 결과: 124732.534\n\n8진수: 124732.534\n16진수: A9DA.AE",
        chapter: "컴퓨터 구조",
        type: "essay"
    },
    {
    ...
    },
    {
        ...
        answer: "AND 연산 기본 원리\nAND 연산은 두 비트가 모두 1일 때만 1이 됩니다.\n\n1 AND 1 = 1\n1 AND 0 = 0\n0 AND 1 = 0\n0 AND 0 = 0\n\n단계별 계산\n1단계: 16진수를 4비트씩 나누어 생각하기\nx10 = 0xFFFF_1234\n     F    F    F    F    1    2    3    4\n   1111 1111 1111 1111 0001 0010 0011 0100\n\nx11 = 0x0000_FF00  \n     0    0    0    0    F    F    0    0\n   0000 0000 0000 0000 1111 1111 0000 0000\n2단계: 각 자리별로 AND 연산\nF AND 0 = 0    →  1111 AND 0000 = 0000 = 0\nF AND 0 = 0    →  1111 AND 0000 = 0000 = 0  \nF AND 0 = 0    →  1111 AND 0000 = 0000 = 0\nF AND 0 = 0    →  1111 AND 0000 = 0000 = 0\n1 AND F = 1    →  0001 AND 1111 = 0001 = 1\n2 AND F = 2    →  0010 AND 1111 = 0010 = 2\n3 AND 0 = 0    →  0011 AND 0000 = 0000 = 0\n4 AND 0 = 0    →  0100 AND 0000 = 0000 = 0\n3단계: 결과 조합\n0 0 0 0 1 2 0 0 = 0x0000_1200\n답: x9 = 0x0000_1200\n핵심은 x11에서 0인 부분(0x0000과 0x00)이 있으면 AND 결과도 무조건 0이 된다",
        chapter: "컴퓨터 구조",
        type: "essay"
    },
    {
        ...
        answer: "주어진 값들\n\nx10 = 00000000 00000000 00001101 11000000\nx12 = 11111111 11111111 11111111 11111111\n\nXOR 연산 수행\nXOR 연산은 비트가 다르면 1, 같으면 0을 반환합니다.\nx10: 00000000 00000000 00001101 11000000\nx12: 11111111 11111111 11111111 11111111\n     --------------------------------\nx9:  11111111 11111111 11110010 00111111\n비트별 계산 확인\n\n0 ⊕ 1 = 1\n1 ⊕ 1 = 0\n\nx10의 각 비트와 x12의 1을 XOR하면, 사실상 x10의 **비트 반전(NOT 연산)**과 같은 결과가 됩니다.\n16진수 변환\n이진수를 16진수로 변환:\n\n11111111 11111111 11110010 00111111 = FFFFF23F\n\n답: x9 = FFFFF23F",
        chapter: "컴퓨터 구조",
        type: "essay"
    },
    {
    ...
    {
        number: "40",
        question: "세 개의 프로세스에 대해 각각 설정된 base 레지스터와 limit 레지스터의 값을 나타낸 것이다. 서로 겹치는 메모리 영역이 있는 프로세스 쌍을 모두 고르시오.\nP1: Base = 100000, Limit = 20000 → 메모리 범위: 100000 ~ 119999\nP2: Base = 115000, Limit = 10000 → 메모리 범위: 115000 ~ 124999\nP3: Base = 130000, Limit = 15000 → 메모리 범위: 130000 ~ 144999",
        answer: "범위 비교:\n\nP1–P2: P1(100000119999)와 P2(115000124999) → 115000~119999 구간에서 겹침 ✅\n\nP1–P3: P1(100000119999)와 P3(130000144999) → 전혀 안 겹침 ❌\n\nP2–P3: P2(115000124999)와 P3(130000144999) → 전혀 안 겹침 ❌",
        chapter: "컴퓨터 구조",
        type: "essay"
    },
    {
        number: "41",
        question: " 1,024개의 워드 크기 페이지를 사용하고 총 64페이지로 구성된 논리 주소 공간을 고려하자. 이 논리 주소 공간은 32프레임의 물리 메모리로 사상된다.\n• 논리 주소는 몇 비트로 구성되는가?\n• 물리 주소는 몇 비트로 구성되는가?",
        answer: "페이지 크기: 1024 워드 = \n2\n10\n2 \n10\n  워드이므로 오프셋(bits) = 10비트.\n\n논리적 페이지 수: 64 = \n2\n6\n2 \n6\n  이므로 페이지 번호(bits) = 6비트.\n→ 논리 주소 전체 = 페이지 번호(6) + 오프셋(10) = 16비트.\n\n물리 프레임 수: 32 = \n2\n5\n2 \n5\n  이므로 프레임 번호(bits) = 5비트.\n→ 물리 주소 전체 = 프레임 번호(5) + 오프셋(10) = 15비트.\n\n정리하면:\n\n논리 주소: 16비트\n\n물리 주소: 15비트",
        chapter: "컴퓨터 구조",
        type: "essay"
    },
    {
        number: "42",
        question: " 32비트 논리 주소와 4KB 페이지 크기의 컴퓨터 시스템을 고려하자. 시스템은 최대 512MB의 물리 메모리를 지원한다. 페이지 테이블에는 몇 개의 항목(entry)이 존재하는가?",
        answer: "1. 페이지 오프셋 비트 수 계산\n\n페이지 크기: 4 KB = \n2\n12\n2 \n12\n  바이트 → 오프셋 = 12비트\n\n2. 페이지 번호 비트 수 계산\n\n논리 주소: 32비트 → 페이지 번호 비트 수 = \n32\n−\n12\n=\n20\n32−12=20 비트\n\n3. 페이지 수 계산\n\n페이지 수 = \n2\n20\n2 \n20\n  = 1,048,576 페이지\n→ 페이지 테이블 엔트리 개수 = 1,048,576 개",
        chapter: "컴퓨터 구조",
        type: "essay"
    },
    {
        number: "43",
        question: "다음은 4개의 논리 주소를 통해 페이지 기반 가상 메모리 시스템에서 실제 물리 주소 및 데이터를 찾는 과정이다. 다음의 각 질문에 답하시오. • 10진수 논리주소 0, 6, 10, 13에 대한 페이지 번 호 p와 변위 d를 순서대로 2진수로 각각 나타내 시오 • 위에서 구한 각 논리 주소에 맵핑되는 물리 주소 의 프레임 번호 f와 변위 d를 2진수로 각각 답하 시오 • 위에서 구한 4개의 물리 주소에 의하여 물리 메 모리에 access된 4개의 문자 데이터를 차례대로 나열하시오",
        answer: "1단계: 논리 주소 분석 (페이지 번호 p와 변위 d)\n\n논리 주소 0 (0000₂): p = 00₂, d = 00₂\n논리 주소 6 (0110₂): p = 01₂, d = 10₂\n논리 주소 10 (1010₂): p = 10₂, d = 10₂\n논리 주소 13 (1101₂): p = 11₂, d = 01₂\n\n2단계: 페이지 테이블을 통한 프레임 번호 찾기\n페이지 테이블에서:\n\n페이지 0 → 프레임 3\n페이지 1 → 프레임 5\n페이지 2 → 프레임 1\n페이지 3 → 프레임 6\n\n물리 주소의 프레임 번호 f와 변위 d (2진수):\n\n논리 주소 0: f = 011₂ (프레임 3), d = 00₂\n논리 주소 6: f = 101₂ (프레임 5), d = 10₂\n논리 주소 10: f = 001₂ (프레임 1), d = 10₂\n논리 주소 13: f = 110₂ (프레임 6), d = 01₂\n\n3단계: 물리 메모리에서 데이터 찾기\n물리 주소 계산 (프레임 번호 × 4 + 변위):\n\n논리 주소 0: 물리 주소 = 3×4 + 0 = 12 → U\n논리 주소 6: 물리 주소 = 5×4 + 2 = 22 → AA\n논리 주소 10: 물리 주소 = 1×4 + 2 = 6 → S\n논리 주소 13: 물리 주소 = 6×4 + 1 = 25 → N",
        chapter: "컴퓨터 구조",
        type: "essay"
    }
]
...
const questionBank = [
    ...
    },
    {
        ...
        explanation: "16진수 D1AF를 2진수로 변환하면 1101 0001 1010 1111이 됩니다. 이를 3자리씩 묶어 8진수로 변환하면 1 101 000 110 101 111 -> 150657이 됩니다."
    },
    {
        question: "2진수 1010100111011010.1010111에 대한 8진수와 16진수 표현을 구하시오.",
        answer: "16진수 변환\n방법: 소수점을 기준으로 4비트씩 그룹화 (16 = 2⁴)\n정수 부분: 1010100111011010\n1010 | 1001 | 1101 | 1010\n  A  |   9  |   D  |   A\n소수 부분: 1010111\n오른쪽에 0을 추가하여 4의 배수로 만듦: 10101110\n1010 | 1110\n  A  |   E\n16진수 결과: A9DA.AE\n8진수 변환 (다시 계산)\n정수 부분: 1010100111011010\n오른쪽부터 3비트씩 그룹화:\n1|010|100|111|011|010\n왼쪽 끝이 1비트이므로 앞에 00 추가: 001010100111011010\n001 | 010 | 100 | 111 | 011 | 010\n 1  |  2  |  4  |  7  |  3  |  2\n소수 부분: 1010111\n왼쪽부터 3비트씩 그룹화하고, 부족하면 오른쪽에 0 추가:\n101 | 011 | 1 → 101 | 011 | 100\n 5  |  3  |  4\n8진수 결과: 124732.534\n\n8진수: 124732.534\n16진수: A9DA.AE",
        explanation: "8진수: 124732.534, 16진수: A9DA.AE"
    },
    {
        question: "다음 SI 단위를 그에 해당하는 10진수 값과 연결하시오.\nSI 단위 10진수 값\nA. kilo(K) ① 10¹²\nB. giga(G) ② 10³\nC. tera(T) ③ 10⁹",
        answer: "A-②, B-③, C-①",
