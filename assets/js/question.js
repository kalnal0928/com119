const questions = [
    ...
    },
    {
        ...
        answer: "16진수 변환\n방법: 소수점을 기준으로 4비트씩 그룹화 (16 = 2⁴)\n정수 부분: 1010100111011010\n1010 | 1001 | 1101 | 1010\n  A  |   9  |   D  |   A\n소수 부분: 1010111\n오른쪽에 0을 추가하여 4의 배수로 만듦: 10101110\n1010 | 1110\n  A  |   E\n16진수 결과: A9DA.AE\n8진수 변환\n방법: 소수점을 기준으로 3비트씩 그룹화 (8 = 2³)\n정수 부분: 1010100111011010\n왼쪽에 0을 추가하여 3의 배수로 만듦: 01010100111011010\n010 | 101 | 001 | 110 | 110 | 010\n마지막 그룹이 2비트이므로 왼쪽에 0 추가: 010 = 010\n010 | 101 | 001 | 110 | 110 | 010\n 2  |  5  |  1  |  6  |  6  |  2\n소수 부분: 1010111\n오른쪽에 0을 추가하여 3의 배수로 만듦: 101011100\n101 | 011 | 100\n 5  |  3  |  4\n8진수 결과: 251662.534\n최종 답안\n\n8진수: 251662.534\n16진수: A9DA.AE",
        chapter: "컴퓨터 구조",
        type: "essay"
    },
    {
